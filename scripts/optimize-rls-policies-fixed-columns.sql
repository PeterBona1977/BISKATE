...
-- Criar políticas otimizadas para gigs (usando 'author_id' em vez de 'user_id')
...
-- Criar políticas otimizadas para gig_responses (usando 'responder_id' em vez de 'user_id')
